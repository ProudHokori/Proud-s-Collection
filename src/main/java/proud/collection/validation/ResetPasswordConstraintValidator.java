...
public class ResetPasswordConstraintValidator implements ConstraintValidator<ResetValidPassword, String> {

    @Override
    public void initialize(ResetValidPassword constraintAnnotation) {
